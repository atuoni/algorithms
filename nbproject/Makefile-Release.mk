...
${OBJECTDIR}/linear_search.o: linear_search.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/linear_search.o linear_search.cpp

${OBJECTDIR}/main_menu.o: main_menu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_menu.o main_menu.cpp

${OBJECTDIR}/recursive_linear_search.o: recursive_linear_search.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/recursive_linear_search.o recursive_linear_search.cpp

${OBJECTDIR}/sentinel_linear_search.o: sentinel_linear_search.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sentinel_linear_search.o sentinel_linear_search.cpp
